...
const CustomButton = ({ label, onClick, icon, variant }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-fit outline-none py-1 px-2 sm:py-2 sm:px-5 rounded-md focus:outline-none flex items-center sm:gap-x-2 border-2 active:scale-105 transition-all duration-300 ${
        variant === "outlined"
